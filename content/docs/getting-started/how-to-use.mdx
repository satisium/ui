...
The easiest way to discover components is the **[Components](/docs/components)** index. It lists every available component grouped by category, with a preview image, description, and status badge.

- **All components** — [/docs/components](/docs/components) shows every component in the library, organized by category.
- **Category pages** — Click a category badge on any component doc, or visit [/categories](/categories) to browse by type (Text Reveals, Image Effects, Carousels, Mouse Trails).
...
| Badge | Color | Meaning |
| :---- | :---- | :------ |
| **New** | <span className="inline-flex items-center gap-1.5"><span className="relative inline-flex size-1.5 rounded-full bg-emerald-500" /><span className="text-emerald-500">Green</span></span> | Recently added component |
| **Updated** | <span className="inline-flex items-center gap-1.5"><span className="size-1.5 rounded-full bg-blue-500" /><span className="text-blue-500">Blue</span></span> | Recently updated with new features or fixes |
| **Beta** | <span className="inline-flex items-center gap-1.5"><span className="size-1.5 rounded-full bg-amber-500" /><span className="text-amber-500">Amber</span></span> | Stable but may still receive breaking changes |
| **Deprecated** | <span className="inline-flex items-center gap-1.5"><span className="size-1.5 rounded-full bg-rose-500/50" /><span className="text-rose-500">Rose</span></span> | Will be removed in a future release |
