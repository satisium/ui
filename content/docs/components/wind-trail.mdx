...
author: Satisium UI
links:
  github: https://github.com/satisium-ui/ui/blob/master/content/docs/components/wind-trail.mdx
registryKeys:
...
<div className="mt-6">
  <CommandBlock command="npx shadcn@latest add https://ui.satisium.com/r/wind-trail.json" title="wind-trail" />
</div>

Or install a specific demo variant:

<div className="mt-6">
  <CommandBlock command="npx shadcn@latest add https://ui.satisium.com/r/wind-trail-avatars-demo.json" title="wind-trail-avatars-demo" />
</div>

Or install a specific demo variant:

<div className="mt-6">
  <CommandBlock command="npx shadcn@latest add https://ui.satisium.com/r/wind-trail-images-demo.json" title="wind-trail-images-demo" />
</div>
