...
author: Satisium UI
links:
  github: https://github.com/satisium/ui/blob/master/content/docs/components/image-effects/liquid-marble.mdx
registryKeys:
  - liquid-marble-image
  - liquid-marble-video
media:
  image: "https://cdn.jsdelivr.net/gh/satisium/ui-assets@main/v2/previews/components/images/liquid-marble.webp"
  video: "https://cdn.jsdelivr.net/gh/satisium/ui-assets@main/v2/previews/components/videos/liquid-marble.mp4"
---
...
<div className="mt-6">
  <CommandBlock
    command="npx shadcn@latest add https://ui.satisium.com/r/liquid-marble.json"
    title="liquid-marble"
  />
</div>
...
<div className="mt-6">
  <CommandBlock
    command="npx shadcn@latest add https://ui.satisium.com/r/liquid-marble-image.json"
    title="liquid-marble-image"
  />
</div>
...
<div className="mt-6">
  <CommandBlock
    command="npx shadcn@latest add https://ui.satisium.com/r/liquid-marble-video.json"
    title="liquid-marble-video"
  />
</div>
