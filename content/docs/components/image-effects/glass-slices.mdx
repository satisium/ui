...
author: Satisium UI
links:
  github: https://github.com/satisium/ui/blob/master/content/docs/components/image-effects/glass-slices.mdx
registryKeys:
  - glass-slices-image
  - glass-slices-video
media:
  image: "https://cdn.jsdelivr.net/gh/satisium/ui-assets@main/v2/previews/components/images/glass-slices.webp"
  video: "https://cdn.jsdelivr.net/gh/satisium/ui-assets@main/v2/previews/components/videos/glass-slices.mp4"
---
...
<div className="mt-6">
  <CommandBlock
    command="npx shadcn@latest add https://ui.satisium.com/r/glass-slices.json"
    title="glass-slices"
  />
</div>
...
<div className="mt-6">
  <CommandBlock
    command="npx shadcn@latest add https://ui.satisium.com/r/glass-slices-image.json"
    title="glass-slices-image"
  />
</div>
...
<div className="mt-6">
  <CommandBlock
    command="npx shadcn@latest add https://ui.satisium.com/r/glass-slices-video.json"
    title="glass-slices-video"
  />
</div>
