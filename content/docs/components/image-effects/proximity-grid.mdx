...
author: Satisium UI
links:
  github: https://github.com/satisium/ui/blob/master/content/docs/components/image-effects/proximity-grid.mdx
registryKeys:
  - proximity-grid-image
  - proximity-grid-video
media:
  image: "https://cdn.jsdelivr.net/gh/satisium/ui-assets@main/v2/previews/components/images/proximity-grid.webp"
  video: "https://cdn.jsdelivr.net/gh/satisium/ui-assets@main/v2/previews/components/videos/proximity-grid.mp4"
---
...
<div className="mt-6">
  <CommandBlock
    command="npx shadcn@latest add https://ui.satisium.com/r/proximity-grid.json"
    title="proximity-grid"
  />
</div>
...
<div className="mt-6">
  <CommandBlock
    command="npx shadcn@latest add https://ui.satisium.com/r/proximity-grid-image.json"
    title="proximity-grid-image"
  />
</div>
...
<div className="mt-6">
  <CommandBlock
    command="npx shadcn@latest add https://ui.satisium.com/r/proximity-grid-video.json"
    title="proximity-grid-video"
  />
</div>
