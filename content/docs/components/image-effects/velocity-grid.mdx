...
author: Satisium UI
links:
  github: https://github.com/satisium/ui/blob/master/content/docs/components/image-effects/velocity-grid.mdx
registryKeys:
  - velocity-grid-image
  - velocity-grid-video
media:
  image: "https://cdn.jsdelivr.net/gh/satisium/ui-assets@main/v2/previews/components/images/velocity-grid.webp"
  video: "https://cdn.jsdelivr.net/gh/satisium/ui-assets@main/v2/previews/components/videos/velocity-grid.mp4"
---
...
<div className="mt-6">
  <CommandBlock
    command="npx shadcn@latest add https://ui.satisium.com/r/velocity-grid.json"
    title="velocity-grid"
  />
</div>
...
<div className="mt-6">
  <CommandBlock
    command="npx shadcn@latest add https://ui.satisium.com/r/velocity-grid-image.json"
    title="velocity-grid-image"
  />
</div>
...
<div className="mt-6">
  <CommandBlock
    command="npx shadcn@latest add https://ui.satisium.com/r/velocity-grid-video.json"
    title="velocity-grid-video"
  />
</div>
