...
author: Satisium UI
links:
  github: https://github.com/satisium/ui/blob/master/content/docs/components/carousels/depth-carousel.mdx
registryKeys:
  - depth-carousel-demo
media:
  image: "https://cdn.jsdelivr.net/gh/satisium/ui-assets@main/v2/previews/components/images/depth-carousel.webp"
  video: "https://cdn.jsdelivr.net/gh/satisium/ui-assets@main/v2/previews/components/videos/depth-carousel.mp4"
---
...
<div className="mt-6">
  <CommandBlock
    command="npx shadcn@latest add https://ui.satisium.com/r/depth-carousel.json"
    title="depth-carousel"
  />
</div>
...
<div className="mt-6">
  <CommandBlock
    command="npx shadcn@latest add https://ui.satisium.com/r/depth-carousel-demo.json"
    title="depth-carousel-demo"
  />
</div>
