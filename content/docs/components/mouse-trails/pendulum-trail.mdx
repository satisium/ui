...
author: Satisium UI
links:
  github: https://github.com/satisium/ui/blob/master/content/docs/components/mouse-trails/pendulum-trail.mdx
registryKeys:
  - pendulum-trail-avatars-demo
  - pendulum-trail-images-demo
media:
  image: "https://cdn.jsdelivr.net/gh/satisium/ui-assets@main/v2/previews/components/images/pendulum-trail.webp"
  video: "https://cdn.jsdelivr.net/gh/satisium/ui-assets@main/v2/previews/components/videos/pendulum-trail.mp4"
---
...
<div className="mt-6">
  <CommandBlock
    command="npx shadcn@latest add https://ui.satisium.com/r/pendulum-trail.json"
    title="pendulum-trail"
  />
</div>
...
<div className="mt-6">
  <CommandBlock
    command="npx shadcn@latest add https://ui.satisium.com/r/pendulum-trail-avatars-demo.json"
    title="pendulum-trail-avatars-demo"
  />
</div>
...
<div className="mt-6">
  <CommandBlock
    command="npx shadcn@latest add https://ui.satisium.com/r/pendulum-trail-images-demo.json"
    title="pendulum-trail-images-demo"
  />
</div>
