...
author: Satisium UI
links:
  github: https://github.com/satisium/ui/blob/master/content/docs/components/mouse-trails/wind-trail.mdx
registryKeys:
  - wind-trail-avatars-demo
  - wind-trail-images-demo
media:
  image: "https://cdn.jsdelivr.net/gh/satisium/ui-assets@main/v2/previews/components/images/wind-trail.webp"
  video: "https://cdn.jsdelivr.net/gh/satisium/ui-assets@main/v2/previews/components/videos/wind-trail.mp4"
---
