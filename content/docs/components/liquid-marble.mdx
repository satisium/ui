...
author: Satisium UI
links:
  github: https://github.com/satisium-ui/ui/blob/master/content/docs/components/liquid-marble.mdx
registryKeys:
  - liquid-marble-image
  - liquid-marble-video
media:
...
<div className="mt-6">
  <CommandBlock command="npx shadcn@latest add https://ui.satisium.com/r/liquid-marble.json" title="liquid-marble" />
</div>

Or install a specific demo variant:

<div className="mt-6">
  <CommandBlock command="npx shadcn@latest add https://ui.satisium.com/r/liquid-marble-image.json" title="liquid-marble-image" />
</div>

Or install a specific demo variant:

<div className="mt-6">
  <CommandBlock command="npx shadcn@latest add https://ui.satisium.com/r/liquid-marble-video.json" title="liquid-marble-video" />
</div>
