...
author: Satisium UI
links:
  github: https://github.com/satisium-ui/ui/blob/master/content/docs/components/proximity-grid.mdx
registryKeys:
...
<div className="mt-6">
  <CommandBlock command="npx shadcn@latest add https://ui.satisium.com/r/proximity-grid.json" title="proximity-grid" />
</div>

Or install a specific demo variant:

<div className="mt-6">
  <CommandBlock command="npx shadcn@latest add https://ui.satisium.com/r/proximity-grid-image.json" title="proximity-grid-image" />
</div>

Or install a specific demo variant:

<div className="mt-6">
  <CommandBlock command="npx shadcn@latest add https://ui.satisium.com/r/proximity-grid-video.json" title="proximity-grid-video" />
</div>
