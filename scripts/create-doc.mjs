...
registryKeys:
  - ${filename}-demo
media:
  image: "https://cdn.jsdelivr.net/gh/satisium/ui-assets@main/v2/previews/components/images/${filename}.webp"
  video: "https://cdn.jsdelivr.net/gh/satisium/ui-assets@main/v2/previews/components/videos/${filename}.mp4"
---
