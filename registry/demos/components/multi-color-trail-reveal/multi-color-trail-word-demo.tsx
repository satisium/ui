    ...
    <main className="w-full bg-background text-foreground antialiased selection:bg-primary/20">
      ...
      <section className="block w-full py-[25vh]">
        <div className="mx-auto max-w-4xl px-6 text-left">
          <p className="mb-6 font-mono text-xs font-medium tracking-widest text-orange-500 uppercase">
            01 // Word × Soft
          </p>
      ...
      <section className="block w-full py-[25vh]">
        <div className="mx-auto max-w-4xl px-6 text-left">
          <p className="mb-6 font-mono text-xs font-medium tracking-widest text-blue-500 uppercase">
            02 // Word × Liquid
          </p>
          <MultiColorTrailReveal
            as="h2"
      ...
      <section className="block w-full py-[25vh]">
        <div className="mx-auto max-w-4xl px-6 text-left">
          <p className="mb-6 font-mono text-xs font-medium tracking-widest text-rose-500 uppercase">
            03 // Word × Hard
          </p>
          <MultiColorTrailReveal
            as="h2"
