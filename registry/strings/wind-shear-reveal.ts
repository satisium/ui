    ...
    <main className="flex h-screen w-full items-center justify-center overflow-hidden bg-background text-foreground antialiased selection:bg-primary/20">
      <div className="px-6 text-center">
        <WindShearReveal
          ...
          delay={0.2}
          duration={1.2}
          stagger={0.2} // Slower stagger emphasizes the individual word impacts
          startingSkew={-35}
          viewportOnce={true}
        />
      </div>
...
export const windShearRevealString = `"use client"
...
export const windShearRevealFile = {
  "wind-shear-reveal.tsx": {
    code: windShearRevealString,
    language: "tsx",
  },
}
