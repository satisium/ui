export const halftoneVideoHeroDemoString = `"use client"
...
export const halftoneVideoHeroString = `"use client"
...
export const halftoneVideoHeroFile = {
  "halftone-video-hero.tsx": {
    code: halftoneVideoHeroString,
    language: "tsx",
  },
}
