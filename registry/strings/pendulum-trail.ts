export const pendulumTrailAvatarsDemoString = `
import PendulumTrail from "@/components/satisium-ui/pendulum-trail"
...
export const pendulumTrailImagesDemoString = `
import PendulumTrail from "@/components/satisium-ui/pendulum-trail"
  ...
  return (
    <main className="relative flex h-screen w-full items-center justify-center overflow-hidden bg-background">
      ...
      <PendulumTrail
        ...
        windSway={8} 
        physicsLength={60} 
        itemClassName="border-4 border-border rounded-2xl overflow-hidden"
      />
    </main>
  )
}`

export const pendulumTrailString = `"use client"
...
export const pendulumTrailFile = {
  "pendulum-trail.tsx": {
    code: pendulumTrailString,
    language: "tsx",
  },
}
