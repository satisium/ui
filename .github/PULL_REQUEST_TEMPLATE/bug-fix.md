...
<!-- Describe the bug. What was broken, and how did you fix it? -->

### Issue Link:

<!-- e.g., "Fixes #12" or "Noticed during local testing" -->

---

## 🛑 Fix Checklist

- [ ] I tested this fix in **Light Mode**.
- [ ] I tested this fix in **Dark Mode**.
...
<!-- If this is a UI fix, please provide screenshots. -->
