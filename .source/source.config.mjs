...
var docs = defineDocs({
  ...
  docs: {
    schema: pageSchema.extend({
      ...
      category: z.array(CategoryEnum).optional().describe("Primary SEO bucket (e.g., ['marketing'])"),
      subcategory: z.array(SubCategoryEnum).optional().describe("Specific UI pattern (e.g., ['heroes', 'interactions'])"),
