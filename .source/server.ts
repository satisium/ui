// @ts-nocheck
import * as __fd_glob_8 from "../content/docs/components/complex/spotlight-card.mdx?collection=docs"
...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, "components/meta.json": __fd_glob_1, "getting-started/meta.json": __fd_glob_2, "components/complex/meta.json": __fd_glob_3, }, {"index.mdx": __fd_glob_4, "components/button.mdx": __fd_glob_5, "components/fluid-switch.mdx": __fd_glob_6, "getting-started/installation.mdx": __fd_glob_7, "components/complex/spotlight-card.mdx": __fd_glob_8, });