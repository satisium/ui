# Concave Carousel Component Context
...
| :----------------- | :--------------------------- | :------------- | :------------------------------------------------------------ |
| `items`            | `ConcaveCarouselItem[]`      | _Required_     | Image array (`{ id, url, alt }`).                             |
| `visibleItems`     | `number`                     | `3`            | Base visible items.                                           |
| `maxHeight`        | `number`                     | `250`          | Center height (px).                                           |
| `minHeight`        | `number`                     | `100`          | Edge height (px).                                             |
...
| `scrollMultiplier` | `number`                     | `0.003`        | Drag sensitivity multiplier.                                  |
