# Halftone Video Horizontal Component Context
...
```bash
npx satisium-ui add halftone-video-horizontal
```
...
| `maxLineThickness` | `number`    | `0.85`  | Max thickness multiplier of the lines relative to vertical spacing. |
...
**File Path:** `components/ui/halftone-video-horizontal.tsx`
...
import HalftoneVideoHorizontal from "@/components/ui/halftone-video-horizontal"
