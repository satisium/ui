...
| :----------------- | :--------------------------- | :------------- | :------------------------------------------------------------ |
| `items`            | `AscentCarouselItem[]`       | _Required_     | Image array (`{ id, url, alt }`).                             |
| `visibleItems`     | `number`                     | `6`            | Base visible items.                                           |
| `maxHeight`        | `number`                     | `600`          | Foreground height (px).                                       |
| `minHeight`        | `number`                     | `150`          | Background height (px).                                       |
...
- https://cdn.jsdelivr.net/gh/satisium/ui-assets@main/v2/in-demo-assets/components/images/stock/12.webp
- https://cdn.jsdelivr.net/gh/satisium/ui-assets@main/v2/in-demo-assets/components/images/stock/13.webp
- https://cdn.jsdelivr.net/gh/satisium/ui-assets@main/v2/in-demo-assets/components/images/stock/14.webp
- https://cdn.jsdelivr.net/gh/satisium/ui-assets@main/v2/in-demo-assets/components/images/stock/15.webp
...
- https://cdn.jsdelivr.net/gh/satisium/ui-assets@main/v2/in-demo-assets/components/images/stock/9.webp
